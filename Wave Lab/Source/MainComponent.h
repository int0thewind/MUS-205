...
public Slider::Listener, public Button::Listener, public ComboBox::Listener, public Timer
{
    ...
    //==============================================================================
    // Timer overrides
    /// The timer callback should get the AudioDeviceManager's cpu usage, convert
    ...
    /// displays an isosceles triangle pointing to the right. To do this
...
//    Random random;
    ...
    DrawableButton playButton {"playButton", juce::DrawableButton::ImageOnButtonBackground};
    ...
    Slider levelSlider {"levelSlider"};

    /// A label that displays the text "Frequency:"
    Label freqLabel {"freqLabel", "Frequency: "};
    ...
    Slider freqSlider {"freqSlider"};

    /// A label that displays the text "Waveforms:"
    Label waveformLabel {"waveformLabel", "Waveforms: "};
     ...
     */
    const StringArray MENU_FIRST_SEC {"White", "Brown", "Dust"};

    /**
     * The second section of the combo box waveform menu
     */
    const StringArray MENU_SECOND_SEC {"Sine"};

    /**
     * The third section of the combo box waveform menu
     */
    const StringArray MENU_THIRD_SEC {"LF Impulse", "LF Square", "LF Sawtooth", "LF Triangle"};

    /**
     * The fourth section of the combo box waveform menu
     */
    const StringArray MENU_FOURTH_SEC {"BL Impulse", "BL Square", "BL Saw", "BL Triangle"};

    /**
     * The fifth section of the combo box waveform menu
     */
    ...
    /**
     * A class variable holds the phase incremental value.
     */
    double phaseDelta {0.0};

    /**
     * A constant holding the value of two Pi.
     */
